...
form.addEventListener("submit", function (e) {
  ...
  // also, input returns string, even though type=number!, thats why we use parseInt;
  // console.log(typeof value);
  //
  // isNan() - function that returns true or false
  if (isNaN(value) || value <= 0 || value > 9) {
    ...
    tempText = tempText
      ...
      .join(""); // join('' '' ) avoids comments in between;
